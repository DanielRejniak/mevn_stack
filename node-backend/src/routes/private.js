...
const private_report_generator_ctrl = require('../controllers/private_report_generator_ctrl');
...
router.post("/generateJSONReport", checkAuth, private_report_generator_ctrl.generateJSONReport);
